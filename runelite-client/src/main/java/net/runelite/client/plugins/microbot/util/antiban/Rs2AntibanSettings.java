...
public class Rs2AntibanSettings {
    ...
    public static boolean contextualVariability = true;
    ...
    public static boolean overwriteScriptSettings = true;
    ...
    public static boolean universalAntiban = true; // Will attempt to use the same antiban settings for all plugins that has not yet implemented their own antiban settings.
